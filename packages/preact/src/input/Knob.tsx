...
export const Knob: FunctionComponent<KnobProps> = ({ size, value, min, max, step, name, disabled, label, detents, format, onArcInput, onArcChange, ...rest }) => {
  ...
  return h('arc-knob', { ref, size, value, min, max, step, name, disabled, label, detents, format, ...rest });
};
