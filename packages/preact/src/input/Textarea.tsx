...
export const Textarea: FunctionComponent<TextareaProps> = ({ required, readonly, value, name, placeholder, label, rows, maxlength, disabled, resize, size, autoResize, error, onArcInput, onArcChange, ...rest }) => {
