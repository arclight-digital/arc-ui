...
export const ThemeToggle: FunctionComponent<ThemeToggleProps> = ({ theme, disabled, iconOnly, size, onArcChange, ...rest }) => {
  ...
  return h('arc-theme-toggle', { ref, theme, disabled, iconOnly, size, ...rest });
};
