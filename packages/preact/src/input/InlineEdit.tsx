...
export const InlineEdit: FunctionComponent<InlineEditProps> = ({ value, label, name, placeholder, multiline, disabled, onArcChange, onArcCancel, onArcInput, children, ...rest }) => {
  ...
  return h('arc-inline-edit', { ref, value, label, name, placeholder, multiline, disabled, ...rest }, children);
};
