...
export const RangeSlider: FunctionComponent<RangeSliderProps> = ({ required, readonly, size, min, max, step, low, high, name, disabled, label, showValues, onArcInput, onArcChange, ...rest }) => {
