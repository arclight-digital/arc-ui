...
export const MultiSelect = forwardRef<ArcMultiSelect, MultiSelectProps>(({ required, readonly, size, value, placeholder, label, name, disabled, onArcChange, onArcInput, children, ...rest }, forwarded) => {
  const ref = useRef<ArcMultiSelect>(null);
  useImperativeHandle(forwarded, () => ref.current as ArcMultiSelect, []);
  useLayoutEffect(() => {
  ...
  return h('arc-multi-select', { ref, required, readonly, size, value, placeholder, label, name, disabled, ...rest }, children);
});
