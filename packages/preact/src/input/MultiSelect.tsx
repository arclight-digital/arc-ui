...
export const MultiSelect: FunctionComponent<MultiSelectProps> = ({ required, readonly, size, value, placeholder, label, name, disabled, onArcChange, onArcInput, children, ...rest }) => {
