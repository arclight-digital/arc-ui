...
<script lang="ts">
  ...
  let { required, readonly, size, length, value = $bindable(''), name = '', disabled = false, type, ...rest }: Props = $props();
...
<arc-otp-input {required} {readonly} {size} {length} {value} {name} {disabled} {type} {...rest}
