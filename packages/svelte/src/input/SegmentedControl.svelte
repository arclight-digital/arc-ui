...
<script lang="ts">
  ...
  let { required, readonly, value = $bindable(''), name = '', disabled, children, ...rest }: Props = $props();
   ...
   */
  export function element(): ArcSegmentedControl | undefined {
    return __el as ArcSegmentedControl | undefined;
  }
...
<arc-segmented-control {required} {readonly} {value} {name} {disabled} bind:this={__el} {...rest}
