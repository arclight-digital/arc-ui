...
<script lang="ts">
  ...
  let { required, readonly, size, value = $bindable(), max, name = '', label = '', disabled = false, ...rest }: Props = $props();
   ...
   */
  export function element(): ArcRating | undefined {
    return __el as ArcRating | undefined;
  }
...
<arc-rating {required} {readonly} {size} {value} {max} {name} {label} {disabled} bind:this={__el} {...rest}
