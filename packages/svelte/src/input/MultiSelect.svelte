...
<script lang="ts">
   ...
   */
  export function element(): ArcMultiSelect | undefined {
    return __el as ArcMultiSelect | undefined;
  }
...
<arc-multi-select {required} {readonly} {size} {value} {placeholder} {label} {name} {disabled} bind:this={__el} {...rest}
