...
<script lang="ts">
  ...
  let { items = [], value = $bindable(''), expandedValues = [], placeholder = 'Select...', label = $bindable(''), name = '', disabled = false, size = 'md', error = '', open = false, ...rest }: Props = $props();
...
<arc-tree-select {items} {value} {placeholder} {label} {name} {disabled} {size} {error} {open} bind:this={__el} {...rest}
