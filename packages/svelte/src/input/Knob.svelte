...
<script lang="ts">
  ...
  let { size = 'md', value = $bindable(0), min = 0, max = 100, step = 1, name = '', disabled = false, label = '', detents = [], format = 'undefined', ...rest }: Props = $props();
...
<arc-knob {size} {value} {min} {max} {step} {name} {disabled} {label} {detents} {format} {...rest}
