...
<script lang="ts">
  ...
  let { required, readonly, checked = $bindable(), indeterminate, disabled = false, size, label = '', name = '', value = $bindable(''), ...rest }: Props = $props();
...
<arc-checkbox {required} {readonly} {checked} {indeterminate} {disabled} {size} {label} {name} {value} {...rest}
