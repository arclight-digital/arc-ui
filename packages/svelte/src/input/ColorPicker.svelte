...
<script lang="ts">
  ...
  let { required, readonly, size, value = $bindable('#4d7ef7'), name = '', presets, disabled = false, label = '', ...rest }: Props = $props();
   ...
   */
  export function element(): ArcColorPicker | undefined {
    return __el as ArcColorPicker | undefined;
  }
...
<arc-color-picker {required} {readonly} {size} {value} {name} {presets} {disabled} {label} bind:this={__el} {...rest}
