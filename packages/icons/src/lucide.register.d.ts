/**
 * Types for lucide.register.js — the side-effecting `./lucide` subpath.
 *
 ...
 * specifier expecting the eager glyph map that `@arclux/arc-ui/icons/lucide`
 * used to be.
 *
 ...
 * message says where the map went: `./all/lucide` for the whole library,
 * `./lucide/<name>` for one glyph.
 */
