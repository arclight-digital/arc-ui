...
@Component({
  ...
  template: `<arc-otp-input [attr.length]="length" [attr.value]="value" [attr.name]="name" [disabled]="disabled" [attr.type]="type" (arc-change)="onArcChange($event)"><ng-content /></arc-otp-input>`,
})
