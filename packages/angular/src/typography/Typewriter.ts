...
@Component({
  ...
  template: `<arc-typewriter [attr.text]="this.text" [attr.speed]="this.speed" [attr.delay]="this.delay" [cursor]="this.cursor" [loop]="this.loop" [nowrap]="this.nowrap" [pauseEnd]="this.pauseEnd" (arc-complete)="this.arcComplete.emit($event)"><ng-content /></arc-typewriter>`,
})
