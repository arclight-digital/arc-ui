...
/* ── Custom ARC themes derived from design tokens ── */
const d = tokens.color;                           // dark palette
const l = { ...tokens.color, ...lightTokens.color }; // light = base + overrides
...
const arcDark  = makeTheme('arc-dark',  'dark',  d);
const arcLight = makeTheme('arc-light', 'light', l);
