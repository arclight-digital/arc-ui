...
export const releases: Release[] = [
  ...
  { version: '1.9.1', date: '2026-02-14', title: 'Icon Loading Fix for Production Builds' },
  ...
  { version: '1.8.3', date: '2026-02-14', title: 'tokens.css → base.css Rename & FOUC Prevention' },
