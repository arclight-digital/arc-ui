...
export const alert: ComponentDef = {
  ...
  overview: `Alerts communicate important contextual messages to users without interrupting their workflow. They appear inline within the page content and draw attention through color-coded variants that convey meaning at a glance — informational, success, warning, or error.
