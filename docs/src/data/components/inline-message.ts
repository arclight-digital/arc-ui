...
export const inlineMessage: ComponentDef = {
  ...
  overview: `InlineMessage provides lightweight, contextual feedback directly within forms and content areas. It uses the same four semantic color variants as alert — info, success, warning, and error — but with a much more compact presentation: just an icon and text, with no background fill, border, or padding.
